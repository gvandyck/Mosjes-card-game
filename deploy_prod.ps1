...
$visuals = @(
    ...
    "docs\Visuals\Cless Teacher.jpg",
    "docs\Visuals\Coert Kasteluck.jpeg",
    "docs\Visuals\Martin senor West.jpeg",
    "docs\Visuals\Chris The All-Rounder.jpg",
    "docs\Visuals\Youri The Speedrunner.jpg",
    "docs\Visuals\alyssa-fissa.jpg"
)
...
Write-Host "Deployment to Main Production branch complete!"
